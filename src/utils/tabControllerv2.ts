...
export const initializeTabControllerv2 = (root: HTMLElement) => {
...
export const initializeTabControllersv2 = (selector = "[data-tabs-root]") => {
  document
    .querySelectorAll<HTMLElement>(selector)
    .forEach(initializeTabControllerv2);
};

export const initializeTabLinkHandlersv2 = (
